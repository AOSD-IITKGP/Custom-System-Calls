...
asmlinkage long sys_proc_info(pid_t pid, unsigned int flags, char __user *buffer, size_t size);
asmlinkage long sys_register_pid(pid_t pid);
asmlinkage long sys_fetch(struct pid_ctxt_switch __user *stats);
